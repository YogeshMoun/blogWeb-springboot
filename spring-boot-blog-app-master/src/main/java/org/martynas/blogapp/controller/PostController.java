...
//        String authUsername = SecurityContextHolder.getContext().getAuthentication().getName();
    ...
    @Secured("ROLE_USER")//if user is registered then user is able to create new post
...
//        String authUsername = SecurityContextHolder.getContext().getAuthentication().getName();
    ...
    public String createNewPost(@Valid @ModelAttribute Post post, BindingResult bindingResult, SessionStatus sessionStatus) {
        System.err.println("POST post: " + post); // for testing  purposes
        ...
        System.err.println("SAVE post: " + post); // for testing purposes
